...
def vehicletab():
    ...
    def record_entry():
        ...
        label_vehicle_id.grid(row=1, column=0,padx=40, pady=30)

        entry_vehicle_id = tk.Entry(add_vehicle_window)
        entry_vehicle_id.grid(row=1, column=1,padx=40, pady=30)

        label_vehicle_type = tk.Label(add_vehicle_window, text="Vehicle Type:")
        label_vehicle_type.grid(row=2, column=0, padx=40, pady=50)
        ...
        button_confirm.grid(row=3, columnspan=2, pady=30, padx=20)
    ...
    def record_exit():
        ...
        label_ticket_id.grid(row=0, column=0, padx=30, pady=60)
        entry_ticket_id = tk.Entry(remove_vehicle_window)
        entry_ticket_id.grid(row=0, column=1, padx=30, pady=60)
        ...
        button_confirm.grid(row=1, columnspan=2, pady=20)
    ...
    def update_vehicle():
        ...
        label_ticket_id.grid(row=0, column=0, padx=30, pady=20)
    ...
    def search_vehicle():
        ...
        label_ticket_id.grid(row=0, column=0, padx=20, pady= 40)
        entry_ticket_id = tk.Entry(search_vehicle_window)
        entry_ticket_id.grid(row=0, column=1, padx=20, pady= 40)
        ...
        button_confirm.grid(row=3, columnspan=2, pady=20)        
    ...
    frame_entry.place(x=300, y=100, width=1300, height=800)

    button_entry = tk.Button(frame_entry, text="Record Entry",  fg= "#FFFFFE", command=record_entry, bg="#39bfa9", width=20, height=4) 
    button_entry.grid(row=4, column=0, pady=100, padx=300)

    button_update = tk.Button(frame_entry, text="Update Vehicle", command=update_vehicle, bg="#39bfa9", width=20, height=4)
    button_update.grid(row=6, column=0, pady=100, padx=40)

    button_exit = tk.Button(frame_entry, text="Record Exit",  fg= "#D7F2ED",  command=record_exit, bg="#BF394F", width=20, height=4) 
    button_exit.grid(row=4, column=1, pady=100, padx=40)

    button_search = tk.Button(frame_entry, text="Search Vehicle", command=search_vehicle, bg="#39bfa9", width=20, height=4) 
    button_search.grid(row=6, column=1, pady=100, padx=40)
    ...
    button_check_availability.grid(row=8, columnspan=9, pady=0, padx= 500)
...
def spacetab():
        ...
        button_add3.grid(row=4, column=1, pady=70, padx=300)
